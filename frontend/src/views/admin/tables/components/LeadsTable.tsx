...
import { MdCancel, MdCheckCircle, MdOutlineError, MdPending } from "react-icons/md";
...
export default function ComplexTable(props: { tableData: any }) {
  ...
  const [currentUserAction, setCurrentUserAction] = useState(tableData[0].action);
  ...
  return (
    <div>
      <ModalCompo onOpen={onOpen} onClose={onClose} isOpen={isOpen} data={data} id={currentUserAction} />
